...
type UserAssetComment = userAssetCommentResolver
...
func (r *userAssetCommentResolver) UserAsset(ctx context.Context) (*userAssetResolver, error) {
	userAssetId, err := r.UserAssetComment.UserAssetId()
	if err != nil {
		return nil, err
	}
